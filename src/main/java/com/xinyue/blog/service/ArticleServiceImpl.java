...
public class ArticleServiceImpl implements ArticleService{
    ...
    @Override
    @CacheEvict(cacheNames = "article", key = "'article_' + #articleVO.id")
    ...
    @Override
    public void saveArticle(ArticleVO articleVO, Article article) {
        if (article == null) {
            article = new Article();
    ...
    @Override
    public void convertBasicArticleInfo(ArticleVO articleVO, Article article) {
