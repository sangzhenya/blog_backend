...
public class DataAspects {
    ...
    public void deviceInfo() {
        ...
        incrScore("deviceScore", deviceInfo.getDevice());
        incrScore("browserScore", deviceInfo.getBrowser());
        incrScore("browserEditionScore", deviceInfo.getBrowser() + deviceInfo.getEdition());
        incrScore("languageScore", deviceInfo.getLanguage());
        incrScore("systemScore", deviceInfo.getSystem());
        incrScore("kernelScore", deviceInfo.getKernel());
